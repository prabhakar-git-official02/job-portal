...
import {
  recruiterPostsThunk,
  recruiterPostUpdateThunk,
} from "../../Thunks/recruiterPostsThunk";
...
const [storeSkill, setStoreSkill] = useState([]);
  ...
  const handleSkillAdd = () => {
    try {
      ...
      setStoreSkill([...storeSkill, AddSkill]);
      setAddSkill("");
      setSkillbtnError(null);
    } catch (err) {
      setSkillbtnError({
      ...
      console.log(
        "RecruiterPost/DialogboxRecruiterPost-handleSkillAdd-Err",
        err?.message,
      );
      return;
    }
  ...
  console.log("storeskill", storeSkill);

  // delete skill
  const handleSkillDelete = (index) => {
    try {
      const newSkills = storeSkill?.filter((_, i) => i !== index);
      setStoreSkill(newSkills);
      setSkillbtnError(null);
    } catch (err) {
      setSkillbtnError({
        msg: "Something went wrong",
      ...
      console.log(
        "RecruiterPost/DialogboxRecruiterPost-handleSkillDelete-Err",
        err?.message,
      );
      return;
    }
  ...
  const handleSave = () => {
    try {
      ...
      console.log(
        "RecruiterPost/DialogboxRecruiterPost-handleSave-Err",
        err?.message,
      );
      return;
    }
  ...
  const handleSubmit = useCallback(async () => {
    try {
      ...
      console.log(
        "RecruiterPost/DialogboxRecruiterPost-handleSubmit-Err",
        err?.message,
      );
      return;
    }
  ...
  }, [ImageUrl, handleSubmit, load, profileImage]);

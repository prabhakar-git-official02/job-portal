...
import { savedJobsThunk, SavedJobsPostThunk } from "../Thunks/savedJobsThunk";
...
function PlatformJobs() {
  ...
  const jobPlatform = query.get("jobPlatform");
  ...
  const PlatformPost =
    ApprovedPosts?.filter(post => post?.jobPlatform.trim().toLowerCase().includes(jobPlatform.trim().toLowerCase()));
  ...
  const filteredPosts = PlatformPost?.filter((p) => {
    const jobTypeMatch =
    ...
    <div className="page-bg min-vh-100">
      ...
      <div className="container py-4 px-3 px-md-4 px-lg-5">
        ...
        <div className="modern-title-container mb-3 text-center text-md-start">
          ...
          <h3 className="modern-title p-2">
            {jobPlatform} Jobs
          </h3>

          <p className="modern-subtitle ">
            Discover jobs from {jobPlatform}
          </p>

...
function MyApplicants() {
  ...
  const [search, setSearch] = useState("");
    ...
    const [applicantStatusKey,setApplicantStatusKey] = useState("")
  ...
  const FilterApplicantStatus = [
    "Shortlisted","Rejected","Pending","All Applicants"
  ]
  ...
  const filteredPosts = userJobs?.filter((p) => {

    const ApplicantStatusMatch =
    applicantStatusKey && applicantStatusKey!=="All Applicants"
    ? p?.status.trim().toLowerCase() === applicantStatusKey.trim().toLowerCase() : true
    ...
    return locationMatch && ApplicantStatusMatch && qualificationMatch;
  });
    ...
    <div className="container-fluid page-bg min-vh-100 px-0">
      ...
      <div className="container py-4 px-3 px-md-4 px-lg-5 mt-4">
        ...
        <div className="modern-title-container text-center mb-3">
          <h3 className="modern-title">Applicants</h3>
        ...
        <div className="d-flex align-items-center gap-2 flex-wrap">
          ...
          <DropDown
            datas={FilterApplicantStatus}
            dataName={applicantStatusKey}
            dropDirection={"down"}
            setDatas={setApplicantStatusKey}
            classname={`premium-dropdown`}
            initialName={`Filter Applicants Status`}
          />
                    <DropDown
